...
class ConfigEngine # rubocop:disable Metrics/ClassLength
  BASE_CONFIG = {
    ...
    'NS Packhouse' => {
      ...
      'Grade Description' => { group: 'Fruit', resolver: 'grade_description', applications: ['Carton', 'Pallet'] },
      ...
      'Label phytodata' => { group: 'Fruit', resolver: 'label_phytodata', applications: ['Carton'] },
      ...
      'Production Run Pool' => { group: 'Packhouse', resolver: 'pool', applications: ['Carton', 'Pallet', 'Rebin'] },
      ...
      'Marketing Org GLN' => { group: 'Marketing', resolver: 'marketing_org_gln', applications: ['Carton', 'Pallet'] },
      ...
      'Marketer Address Lines' => { group: 'Marketing', resolver: 'marketer_address_lines', applications: ['Carton'] },
      'Marketer Address City and Code' => { group: 'Marketing', resolver: 'marketer_address_city_code', applications: ['Carton'] },
      ...
      'Treatment Line1' => { group: 'Marketing', resolver: 'treatment_line1', applications: ['Carton', 'Pallet'] },
      'Treatment Line2' => { group: 'Marketing', resolver: 'treatment_line2', applications: ['Carton', 'Pallet'] },
      'Treatment Line3' => { group: 'Marketing', resolver: 'treatment_line3', applications: ['Carton', 'Pallet'] },
      'Actual Cold Treatment' => { group: 'Marketing', resolver: 'actual_cold_treatment', applications: ['Carton', 'Pallet', 'Rebin'] },
      'Actual Ripeness Treatment' => { group: 'Marketing', resolver: 'actual_ripeness_treatment', applications: ['Carton', 'Pallet', 'Rebin'] },
