...
class ConfigEngine # rubocop:disable Metrics/ClassLength
  BASE_CONFIG = {
    ...
    'NS Packhouse' => {
      ...
      'Standard Pack Label Code' => { group: 'Carton', resolver: 'std_pack_label_code', applications: ['Cartons'] },
      ...
      'Grade' => { group: 'Fruit', resolver: 'grade_code', applications: ['Cartons'] },
      ...
      'Marketing Variety Description' => { group: 'Fruit', resolver: 'marketing_variety_description', applications: ['Cartons'] },
      ...
      'Size Count UOM' => { group: 'Fruit', resolver: 'size_count_uom', applications: ['Cartons'] },
      ...
      'PHC' => { group: 'Packhouse', resolver: 'phc', applications: ['Cartons'] },
      'Pick Ref' => { group: 'Packhouse', resolver: 'pick_ref', applications: ['Cartons'] },
