...
class ConfigEngine # rubocop:disable Metrics/ClassLength
  BASE_CONFIG = {
    ...
    'NS Packhouse' => {
      ...
      'Farm' => { group: 'Farm', resolver: 'farm_code', applications: ['Bin', 'Carton', 'Pallet', 'Rebin'] },
      'Farm Group' => { group: 'Farm', resolver: 'farm_group_code', applications: ['Carton', 'Pallet'] },
      'Orchard' => { group: 'Farm', resolver: 'orchard_code', applications: ['Bin', 'Carton', 'Pallet', 'Rebin'] },
      ...
      'Production Run ID' => { group: 'Packhouse', resolver: 'production_run_id', applications: ['Carton', 'Pallet', 'Rebin'] },
