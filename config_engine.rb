...
class ConfigEngine # rubocop:disable Metrics/ClassLength
  BASE_CONFIG = {
    ...
    'NS Packhouse' => {
      ...
      'Basic Pack' => { group: 'Carton', resolver: 'basic_pack_code', applications: ['Carton'] },
      'Carton Number' => { group: 'Carton', resolver: 'carton_label_id', applications: ['Carton'] },
      'Pallet Number' => { group: 'Carton', resolver: 'pallet_number', applications: ['Cartons', 'Pallets'] },
      ...
      'Standard Pack' => { group: 'Carton', resolver: 'standard_pack_code', applications: ['Carton'] },
      'Standard Pack Label Code' => { group: 'Carton', resolver: 'std_pack_label_code', applications: ['Carton'] },
      'Template' => { group: 'Carton', resolver: 'template_name', applications: ['Carton'] },
      'Farm' => { group: 'Farm', resolver: 'farm_code', applications: ['Carton'] },
      'Orchard' => { group: 'Farm', resolver: 'orchard_code', applications: ['Bins', 'Carton'] },
      'PUC' => { group: 'Farm', resolver: 'puc_code', applications: ['Carton'] },
      'Actual Count' => { group: 'Fruit', resolver: 'actual_count_for_pack', applications: ['Carton'] },
      ...
      'Commodity' => { group: 'Fruit', resolver: 'commodity', applications: ['Carton'] },
      'Cultivar Group' => { group: 'Fruit', resolver: 'cultivar_group_code', applications: ['Carton'] },
      'Cultivar' => { group: 'Fruit', resolver: 'cultivar_name', applications: ['Bins', 'Carton'] },
      'Customer Variety' => { group: 'Fruit', resolver: 'customer_variety_code', applications: ['Carton'] },
      'Grade' => { group: 'Fruit', resolver: 'grade_code', applications: ['Carton'] },
      'Inventory Code' => { group: 'Fruit', resolver: 'inventory_code', applications: ['Carton'] },
      'Mark' => { group: 'Fruit', resolver: 'mark_code', applications: ['Carton'] },
      'Marketing Variety' => { group: 'Fruit', resolver: 'marketing_variety_code', applications: ['Carton'] },
      'Marketing Variety Description' => { group: 'Fruit', resolver: 'marketing_variety_description', applications: ['Carton'] },
      'Packed TM' => { group: 'Fruit', resolver: 'packed_tm_group', applications: ['Carton'] },
      'Product Code' => { group: 'Fruit', resolver: 'product_code', applications: ['Carton'] },
      'Season' => { group: 'Fruit', resolver: 'season_code', applications: ['Carton'] },
      'Size Count' => { group: 'Fruit', resolver: 'size_count_value', applications: ['Carton'] },
      'Size Count UOM' => { group: 'Fruit', resolver: 'size_count_uom', applications: ['Carton'] },
      'Size Reference' => { group: 'Fruit', resolver: 'size_reference', applications: ['Carton'] },
      'Line' => { group: 'Packhouse', resolver: 'line', applications: ['Carton'] },
      'Packhouse' => { group: 'Packhouse', resolver: 'packhouse', applications: ['Carton'] },
      'PHC' => { group: 'Packhouse', resolver: 'phc', applications: ['Carton'] },
      'Pick Ref' => { group: 'Packhouse', resolver: 'pick_ref', applications: ['Carton'] },
      'Production Run ID' => { group: 'Packhouse', resolver: 'production_run_id', applications: ['Carton'] },
      ...
      'Marketing Order No' => { group: 'Marketing', resolver: 'marketing_order_number', applications: ['Carton'] },
      'Treatments' => { group: 'Marketing', resolver: 'treatments', applications: ['Carton'] },
