...
class ConfigEngine # rubocop:disable Metrics/ClassLength
  BASE_CONFIG = {
    ...
    'NS Packhouse' => {
      ...
      'Farm' => { group: 'Farm', resolver: 'farm_code', applications: ['Bin', 'Carton', 'Pallet', 'Rebin', 'QC'] },
      'Farm Group' => { group: 'Farm', resolver: 'farm_group_code', applications: ['Carton', 'Pallet'] },
      'Orchard' => { group: 'Farm', resolver: 'orchard_code', applications: ['Bin', 'Carton', 'Pallet', 'Rebin', 'QC'] },
      'Marketing Orchard' => { group: 'Farm', resolver: 'marketing_orchard', applications: ['Carton', 'Pallet'] },
      'PUC' => { group: 'Farm', resolver: 'puc_code', applications: ['Bin', 'Carton', 'Pallet', 'Rebin', 'QC'] },
      ...
      'Cultivar' => { group: 'Fruit', resolver: 'cultivar_name', applications: ['Bin', 'Carton', 'Pallet', 'Rebin', 'QC'] },
      ...
      'RMT Code' => { group: 'Bin', resolver: 'rmt_code', applications: ['QC'] },
